В файле lambda лежит реализация Чёрч-style типизации лямбда термов и соответствующий тайп-чекер. Стратегия написания кода понятна и относительно проста:
